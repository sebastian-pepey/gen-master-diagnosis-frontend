...
const LineChart = () => {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:3010/api/v1/loadFile')
    ...
    console.log(d3.select('#d3demo').style('width'))
    ...
    //     .attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
        ...
        //     .domain(d3.extent(stocks, function (d) { return d.date }))
        //     .range([0, width])
        ...
        // const max = d3.max(stocks, function (d) { return d.count })
    ...
    return (
        <div id='d3demo' height="3300" width="2550">
            {/* <svg ref={d3Chart}></svg> */}
        </div>
    )
}
